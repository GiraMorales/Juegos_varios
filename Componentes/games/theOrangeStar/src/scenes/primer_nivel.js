export default class Primer_Nivel extends Phaser.Scene {
    ...
    create() {
      ...
      //plataformas
       ...
       this.physics.add.collider(this.player, this.platform, this.platformImpact, null, this);
       ...
       this.physics.add.collider(this.player, this.malos, this.hitMalo, null, this);
       ...
       //contador de vidas escala color
        this.liveCounter = this.add.text(300, 16, 'vidas: 3', { fontSize: '25px', fill: '#000' }); 
          
         //puntos, posición escala y color 
        this.scoreText = this.add.text(300, 40, 'score: 0', { fontSize: '25px', fill: '#000' }); 
